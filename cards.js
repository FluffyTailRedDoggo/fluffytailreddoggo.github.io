...
$.each(arr, function(i) {
    var templateString = '<div class="card" style="width: 18rem;">    <img class="card-img-top" src="'+ arr[i].url +'" alt="Card image cap">      <div class="card-body">  <h5>' + arr[i].title + '</h5> </p></div> </div>';
